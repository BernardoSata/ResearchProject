...
def move(drone, web3, simulation_ratio, number_of_cycles):        
    ...
    while drone.sequence <= number_of_cycles:
        drone.get_next_wp()
        ...
        sleep(time_1/simulation_ratio)                             # Might want to divide the time to speed up simulation
